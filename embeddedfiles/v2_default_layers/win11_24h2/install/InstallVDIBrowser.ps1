...
$environmentUrls = @{
    "Development" = "https://dev.install.exams.schoolyear.app/schoolyear-exams-browser-win-3.17.5.msi"
    "Testing" = "https://testing.install.exams.schoolyear.app/schoolyear-exams-browser-win-3.17.5.msi"
    "Beta" = "https://beta.install.exams.schoolyear.app/schoolyear-exams-browser-win-3.17.5.msi"
    "Production" = "https://install.exams.schoolyear.app/schoolyear-exams-browser-win-3.17.5.msi"
}
