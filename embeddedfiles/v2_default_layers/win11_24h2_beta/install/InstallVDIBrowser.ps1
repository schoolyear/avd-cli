...
$environmentUrls = @{
    "Development" = "https://dev.install.exams.schoolyear.app/schoolyear-exams-browser-win-3.15.2.msi"
    "Testing" = "https://testing.install.exams.schoolyear.app/schoolyear-exams-browser-win-3.15.2.msi"
    "Beta" = "https://beta.install.exams.schoolyear.app/schoolyear-exams-browser-win-3.15.2.msi"
    "Production" = "https://install.exams.schoolyear.app/schoolyear-exams-browser-win-3.15.2.msi"
}
